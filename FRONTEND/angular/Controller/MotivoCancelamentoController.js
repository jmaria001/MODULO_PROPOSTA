angular.module('App').controller('MotivoCancelamentoController', ['$scope', '$rootScope', 'httpService', '$location', '$timeout', function ($scope, $rootScope, httpService, $location, $timeout) {
    ...
    { 'title': 'Descricão', 'visible': true, 'searchable': true, 'sortable': true },
    ];
    ...
    //====================Carrega o Grid
    $scope.CarregarMotivoCancelamento = function () {
        $rootScope.routeloading = true;
        $scope.Motivos = [];
        $scope.ShowGrid = false;
        $('#dataTable').dataTable().fnDestroy();
        httpService.Get('MotivoCancelamentoListar').then(function (response) {
            if (response) {
    ...
    $scope.$watch('$viewContentLoaded', function () {
        $scope.ConfiguraGrid();
        $scope.CarregarMotivoCancelamento();
    });
    $scope.EditarMotivoCancelamento
