...
namespace PROPOSTA
{
    ...
    {
        public DataTable CarregarPrevisaoVendasAgencia(FiltroModel pParam)
        {
        ...
        public DataTable CarregarPrevisaoVendasVeiculo(FiltroModel pParam)
        {
            clsConexao cnn = new clsConexao(this.Credential);
            cnn.Open();
            SqlDataAdapter Adp = new SqlDataAdapter();
        ...
        public Boolean SalvarPrevisaoVendasAgencia(List<PrevisaoVendas.PrevisaoVendasAgenciaModel> pParam)
        {
            clsConexao cnn = new clsConexao(this.Credential);
            cnn.Open();
            SimLib clsLib = new SimLib();
        ...
        public Boolean SalvarPrevisaoVendasVeiculo(List<PrevisaoVendas.PrevisaoVendasVeiculoModel> pParam)
        {
            clsConexao cnn = new clsConexao(this.Credential);
            cnn.Open();
            SimLib clsLib = new SimLib();
