angular.module('App').controller('PendenciaAprovacaoController', ['$scope', '$rootScope', '$location','httpService','$location', function ($scope, $rootScope, $location,httpService,$location) {

    //====================Inicializa scopes
    $scope.CurrentShow = "Grid";

    $scope.gridheaders = [  { 'title': 'Id', 'visible': true, 'searchable': true, 'config': true, 'sortable': true },
                            ...
                            { 'title': 'Aprovar', 'visible': true, 'searchable': false, 'config': false, 'sortable': false}
    ];
    ...
    $scope.CarregarSimulacao = function () {
        ...
        _url += '?Processo=A' 
        _url += '&Id_Status=' 
        _url += '&Validade_Inicio=' 
        _url += '&Validade_Termino=' 
        _url += '&Cod_Empresa_Venda=' 
        _url += '&Cod_Agencia=' 
        _url += '&Cod_Cliente=' 
        _url += '&Cod_Contato=' 
        _url += '&';
