angular.module('App').controller('ParametroController', ['$scope', '$rootScope', 'httpService', '$location', '$timeout', function ($scope, $rootScope, httpService, $location, $timeout) {
    ...
    { 'title': 'Chave', 'visible': true, 'searchable': true, 'sortable': true },
    { 'title': 'Individual', 'visible': true, 'searchable': true, 'sortable': true },
    ];
    ...
    //====================Carrega o Grid
    $scope.CarregarParametro = function () {
        $rootScope.routeloading = true;
        $scope.Parametros = [];
        $scope.ShowGrid = false;
        $('#dataTable').dataTable().fnDestroy();
        httpService.Get('ParametroListar').then(function (response) {
            if (response) {
