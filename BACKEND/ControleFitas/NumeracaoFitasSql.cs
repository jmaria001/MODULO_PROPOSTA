...
namespace PROPOSTA
{
    ...
    public partial class NumeracaoFitas
    {
        ...
        //public NumeracaoFitasModel ExibirVeiculosFitas(String Cod_Empresa, Int32 Numero_Mr, Int32 Sequencia_Mr)
        //{
        //    clsConexao cnn = new clsConexao(this.Credential);
        //    cnn.Open();
        //    SqlDataAdapter Adp = new SqlDataAdapter();
        //    DataTable dtb = new DataTable("dtb");
        //    SimLib clsLib = new SimLib();
        //    NumeracaoFitasModel TabelaVeiculacao = new NumeracaoFitasModel();
        //    try
        //    {
        ...
        //        cnn.Close();
        //    }
        //    return TabelaVeiculacao;
        //}


        //public DataTable ExibirVeiculosFitas(FiltroExibirVeiculoModel pFiltro)
