...
namespace PROPOSTA
{
    public partial class ConsultaRoteiroOrdenado
    {
        ...
        public ConsultaRoteiroOrdenado(String pCredential)
        {
            this.Credential = pCredential;
            this.CurrentUser = clsLib.Decriptografa(clsLib.GetJsonItem(this.Credential, "Name"));
        }

        public class ConsultaRoteiroOrdenadoModel
        {
            ...
            public Int32  Indica_Corte          { get; set; }
        ...
        public class ConsultaRoteiroOrdenadoFiltroModel
        {
            public String Cod_Veiculo { get; set; }
        ...
        public class ConsultaRoteiroOrdenadoComercialModel
        {
            public Int32 Id_Item { get; set; }
            public String Origem { get; set; }
            public Boolean Indica_Titulo_Programa { get; set; }
