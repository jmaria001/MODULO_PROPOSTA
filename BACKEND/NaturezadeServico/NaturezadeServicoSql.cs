    ...
    public partial class NaturezadeServico
    {
        ...
        public NaturezadeServicoModel GetNaturezadeServicoData(String Cod_Natureza,String Cod_Empresa)
        {
            ...
            try
            {
                ...
                if (dtb.Rows.Count > 0)
                {
                    ...
                    NaturezadeServico.Percentual_Iss          = dtb.Rows[0]["Percentual_Iss"].ToString();
                    ...
                    NaturezadeServico.Perc_IR                 = dtb.Rows[0]["Perc_IR"].ToString();
                    NaturezadeServico.Perc_CS                 = dtb.Rows[0]["Perc_CS"].ToString();
                    NaturezadeServico.Perc_COFINS             = dtb.Rows[0]["Perc_COFINS"].ToString();
                    NaturezadeServico.Perc_PIS                = dtb.Rows[0]["Perc_PIS"].ToString();
                    NaturezadeServico.PERC_INSS               = dtb.Rows[0]["PERC_INSS"].ToString();
        ...
        public DataTable SalvarNaturezadeServico(NaturezadeServicoModel pNaturezadeServico)
        {
            ...
            try
            {
                ...
                Adp.SelectCommand.Parameters.AddWithValue("@Par_Percentual_Iss", pNaturezadeServico.Percentual_Iss.ConvertToDecimal());
                ...
                Adp.SelectCommand.Parameters.AddWithValue("@Par_Perc_IR", pNaturezadeServico.Perc_IR.ConvertToDecimal());
                Adp.SelectCommand.Parameters.AddWithValue("@Par_Perc_CS", pNaturezadeServico.Perc_CS.ToString().ConvertToDecimal());
                Adp.SelectCommand.Parameters.AddWithValue("@Par_Perc_COFINS", pNaturezadeServico.Perc_COFINS.ConvertToDecimal());
                Adp.SelectCommand.Parameters.AddWithValue("@Par_Perc_PIS", pNaturezadeServico.Perc_PIS.ConvertToDecimal());
                Adp.SelectCommand.Parameters.AddWithValue("@Par_PERC_INSS", pNaturezadeServico.PERC_INSS.ConvertToDecimal());
